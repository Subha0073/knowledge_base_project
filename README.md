...
Contract ID = CDHZYEFKNTGBUOUSCJS2T7JASGHPCZIC2Y37BOWD537NSFLXLQQSLFJT
...
_(Click to view, or download `demo.webp` to view the full recorded interaction flow)._
...
![Stellar KB System Architecture Diagram](./my-stellar-app/src/assets/diagram-export-7-4-2026-1_36_00-am.png)
...
_Contract Hash:_ `CDHZYEFKNTGBUOUSCJS2T7JASGHPCZIC2Y37BOWD537NSFLXLQQSLFJT`
